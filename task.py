...
rules_dict = \
    ...
    'all_new' : ['overlap','zero_gap','gap','odr','odrd']}
...
# add by yichen
def odr_(config, mode, anti_response, **kwargs):
    dt = config['dt']
    rng = config['rng']
    if mode == 'random': # Randomly generate parameters
        batch_size = kwargs['batch_size']
...
def odr(config, mode, **kwargs):
    return odr_(config, mode, False, **kwargs)
# add by yichen
...
# add by yichen
def gap_(config, mode, anti_response, **kwargs):
    dt = config['dt']
    rng = config['rng']
    if mode == 'random': # Randomly generate parameters
        batch_size = kwargs['batch_size']
...
def gap(config, mode, **kwargs):
    return gap_(config, mode, True, **kwargs)
